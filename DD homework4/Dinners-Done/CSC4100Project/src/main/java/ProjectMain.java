...
class Recipe {
    ...
    public void setUserAdded(String userAdded) {this.userAdded = userAdded;}

    public void setUnitOfMeasurement(int[] unitOfMeasurement) {this.unitOfMeasurement = unitOfMeasurement;}
