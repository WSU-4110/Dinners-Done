public class User {
    ...
    String[] favorites;   //TODO: set size of array to match array size in recipe db
               ...
               //NEED User DB info and Web site for verification of user info
    private boolean userMatchInfo(String providedName, String providedPassword){
        if(userName == providedName && password == providedPassword) {
            return true;
        }
        else return false;  //TODO: link to display language for "incorrect user name or password"
    }
